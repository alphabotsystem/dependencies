...
PARAMETERS = {
	"timeframes": [
		...
		Parameter(10, "10-minute", ["10", "10m", "10min", "10mins", "10minute", "10-minute", "10minutes"], bookmap="10m"),
	...
	"indicators": [
		...
		Parameter("regression", "Linear Regression Slope", ["regression", "lr", "linreg", "linearregression", "linearregressionslope"], tradingview="LinearRegression@tv-basicstudies", premium="Linear Regression Slope"),
		...
		Parameter("rsi", "RSI", ["rsi"], tradingview="RSI@tv-basicstudies", premium="Relative Strength Index", gocharting="RSI", dynamic={"GoCharting": [14, 20, 80]}),
		...
		Parameter("volumeprofile", "Volume Profile", ["volumeprofile"], premium="Volume Profile Visible Range", gocharting="VOLUMEPROFILE"),
	...
	"types": [
		...
		Parameter("candleStyle", "Renko", ["renko"], tradingview="&style=4", premium="&chartType=4", gocharting="&charttype=RENKO"),
		Parameter("candleStyle", "Kagi", ["kagi"], tradingview="&style=5", premium="&chartType=5", gocharting="&charttype=KAGI"),
		Parameter("candleStyle", "Point&Figure", ["point", "figure", "pf", "paf", "point&figure"], tradingview="&style=6", premium="&chartType=6", gocharting="&charttype=POINT_FIGURE"),
		Parameter("candleStyle", "Line break", ["break", "linebreak", "lb"], tradingview="&style=7", premium="&chartType=7", gocharting="&charttype=LINEBREAK"),
		...
		Parameter("candleStyle", "Range", ["range"], premium="&chartType=11"),
