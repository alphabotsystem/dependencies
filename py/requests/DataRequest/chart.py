...
PARAMETERS = {
	...
	"indicators": [
		...
		Parameter("tpo", "Market Profile", ["tpo", "marketprofile"], premium="Volume Profile Visible Range", gocharting="MARKETPROFILE"),
		...
		Parameter("volumeprofile", "Volume Profile", ["volumeprofile", "vpvr"], premium="Volume Profile Visible Range", gocharting="VOLUMEPROFILE"),
